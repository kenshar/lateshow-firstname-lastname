...
Installation
Clone the repository (replace with your actual repo name):
...
Import the collection: challenge-4-lateshow.postman_collection.json
Run the requests to test all endpoints
